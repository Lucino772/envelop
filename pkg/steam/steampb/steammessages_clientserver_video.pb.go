...
var file_steammessages_clientserver_video_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x35, 0x48, 0x01, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_steammessages_clientserver_video_proto_goTypes = []interface{}{
...
func file_steammessages_clientserver_video_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_steammessages_clientserver_video_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_steammessages_clientserver_video_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_steammessages_clientserver_video_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_steammessages_clientserver_video_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_steammessages_clientserver_video_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_steammessages_clientserver_video_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
