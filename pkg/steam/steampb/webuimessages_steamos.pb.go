...
var file_webuimessages_steamos_proto_rawDesc = []byte{
	...
	0x04, 0x80, 0x97, 0x22, 0x01, 0x42, 0x35, 0x48, 0x01, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75,
...
func file_webuimessages_steamos_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_webuimessages_steamos_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
		...
		file_webuimessages_steamos_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
		...
		file_webuimessages_steamos_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
